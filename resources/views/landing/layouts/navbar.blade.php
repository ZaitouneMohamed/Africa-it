                    ...
                    <div class="ah-lg-mode">
                        ...
                        <ul class="ah-list ah-list--design1 ah-list--link-color-white">
                            ...
                            <li data-tooltip="tooltip" data-placement="left" title="Twitter">
                                <a href="#"><i class="fa-brands fa-square-x-twitter" style="color: rgb(0, 0, 0)"></i></a>
                            </li>
                        ...
                        <ul class="ah-list">
                            <li class="has-dropdown">
                                ...
                                <span class="mega-text">
                                    <i class="fa-solid fa-bars"></i><span style="margin-left: 10px;font-size: initial;">Categories</span>
                                </span>
