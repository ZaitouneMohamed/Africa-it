                        ...
                        <div class="col-lg-6 col-md-8 u-s-m-b-30">
                            <div class="l-f-o">
                                ...
                                <div class="l-f-o__pad-box">
                                    ...
                                    <form class="l-f-o__form" action="{{ route('reset.password.post') }}" method="post">
                                        @csrf
                                        @method('POST')
                                        ...
                                        <div class="u-s-m-b-30">
                                            ...
                                            <input class="input-text input-text--primary-style" type="email"
                                                id="reset-email" placeholder="Enter E-mail" name="email">
                                        </div>
                                        <div class="u-s-m-b-30">
                                            ...
                                            <input class="input-text input-text--primary-style" type="password"
                                                id="reset-email" placeholder="......." name="password">
                                        </div>
                                        <div class="u-s-m-b-30">
                                            ...
                                            <input class="input-text input-text--primary-style" type="password"
                                                id="reset-email" placeholder="......" name="password_confirmation">
                                        </div>
                                        <div class="u-s-m-b-30">
