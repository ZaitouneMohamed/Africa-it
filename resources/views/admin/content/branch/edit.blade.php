        ...
        <form method="POST" action="{{ route('admin.branch.update', $branch->id) }}">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputEmail1" name="attitude"
                        value="{{ $branch->attitude }}" placeholder="Enter attitude">
                </div>
                <div class="form-group">
                    <label for="exampleInputEmail1">longtitude</label>
                    <input type="text" class="form-control" id="exampleInputEmail1" name="longtitude"
                        value="{{ $branch->longtitude }}" placeholder="Enter attitude">
                </div>
                <div class="form-group">
                    <label for="exampleInputEmail1">distance</label>
                    <input type="text" class="form-control" id="exampleInputEmail1" name="distance"
                        value="{{ $branch->distance }}" placeholder="Enter attitude">
                </div>
                <div class="form-group">
